...
CGameTimer::CGameTimer()
{
	...
	else
	{
		...
		//m_nLastTime = ::srand(timeGetTime());//225737875;//
		::QueryPerformanceFrequency((LARGE_INTEGER*)&m_nLastTime);
		m_fTimeScale = 0.001f;
	}
	m_nSampleCount = 0;
...
void CGameTimer::Tick(float fLockFPS)
{
	...
	{
		//m_nCurrentTime = 225737875; //::timeGetTime();
		::QueryPerformanceFrequency((LARGE_INTEGER*)&m_nCurrentTime);
	}
